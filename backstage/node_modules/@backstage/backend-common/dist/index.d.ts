 ...
 * @public
 */
declare type LegacyCreateRouter<TEnv> = (deps: TEnv) => Promise<RequestHandler>;
/** @ignore */
 ...
 * @public
 */
declare class SingleHostDiscovery implements DiscoveryService {
 ...
 * @public
 */
declare type ReadUrlResponseFactoryFromStreamOptions = {
    etag?: string;
    lastModifiedAt?: Date;
};
/**
 ...
 * @public
 */
declare type ReadTreeResponseFactoryOptions = {
    stream: Readable;
    subpath?: string;
    etag: string;
 ...
 * @public
 */
declare type FromReadableArrayOptions = Array<{
    /**
     * The raw data itself.
     */
    data: Readable;
 ...
 * @public
 */
declare type UrlReadersOptions = {
    /** Root config object */
    config: Config;
 ...
 * @public
 */
declare type RequestLoggingHandlerFactory = (logger?: LoggerService) => RequestHandler;
 ...
 * @public
 */
declare type KubernetesContainerRunnerMountBase = {
    volumeName: string;
    basePath: string;
};
/**
 ...
 * @public
 */
declare type KubernetesContainerRunnerOptions = {
