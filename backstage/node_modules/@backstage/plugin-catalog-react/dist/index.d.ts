 ...
 * @public
 */
declare type EntityRefLinksProps<TRef extends string | CompoundEntityRef | Entity> = ({
    defaultKind?: string;
    entityRefs: TRef[];
    fetchEntities?: false;
 ...
 * @public
 */
declare type EntityPeekAheadPopoverProps = PropsWithChildren<{
    entityRef: string;
    delayTime?: number;
}>;
/**
...
/** @public */
declare type EntityTagPickerProps = {
    showCounts?: boolean;
};
/** @public */
...
/** @public */
declare type CatalogReactEntityProcessingStatusPickerClassKey = 'input';
/** @public */
declare const EntityProcessingStatusPicker: () => JSX.Element;

/** @public */
declare type EntityLoadingStatus<TEntity extends Entity = Entity> = {
    entity?: TEntity;
    loading: boolean;
    error?: Error;
...
/** @public */
declare type CatalogReactComponentsNameToClassKey = {
