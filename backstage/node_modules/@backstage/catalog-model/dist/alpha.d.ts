 ...
 * @alpha
 */
declare type EntityStatusLevel = 'info' | 'warning' | 'error';
...
export { AlphaEntity, EntityStatus, EntityStatusItem, EntityStatusLevel };
