 ...
 * @public
 */
declare type QueryEntitiesRequest = QueryEntitiesInitialRequest | QueryEntitiesCursorRequest;
/**
 ...
 * @public
 */
declare type QueryEntitiesInitialRequest = {
    fields?: string[];
    limit?: number;
    filter?: EntityFilterQuery;
 ...
 * @public
 */
declare type QueryEntitiesCursorRequest = {
    fields?: string[];
    limit?: number;
    cursor: string;
};
 ...
 * @public
 */
declare type QueryEntitiesResponse = {
    items: Entity[];
    totalItems: number;
    pageInfo: {
        nextCursor?: string;
