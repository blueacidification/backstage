...
const LazyAsyncApiDefinition = React.lazy(
  () => import('./esm/index/AsyncApiDefinition-cc50bace.esm.js').then((m) => ({
...
const LazyGraphQlDefinition = React.lazy(
  () => import('./esm/index/GraphQlDefinition-1e0f1897.esm.js').then((m) => ({
...
const LazyOpenApiDefinition = React.lazy(
  () => import('./esm/index/OpenApiDefinition-b58baeb3.esm.js').then((m) => ({
...
const ApiExplorerPage = apiDocsPlugin.provide(
  createRoutableExtension({
    ...
    component: () => import('./esm/index/index-3ee49c99.esm.js').then((m) => m.ApiExplorerIndexPage),
...
const EntityApiDefinitionCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index/index-810371c6.esm.js').then((m) => m.ApiDefinitionCard)
    }
  })
);
const EntityConsumedApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index/index-f4134bcd.esm.js').then((m) => m.ConsumedApisCard)
    }
  })
);
const EntityConsumingComponentsCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index/index-264f4920.esm.js').then(
...
const EntityProvidedApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index/index-f4134bcd.esm.js').then((m) => m.ProvidedApisCard)
    }
  })
);
...
const EntityHasApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index/index-f4134bcd.esm.js').then((m) => m.HasApisCard)
    }
  })
);
