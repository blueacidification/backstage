...
import { AnalyzeLocationRequest as AnalyzeLocationRequest$1, AnalyzeLocationResponse as AnalyzeLocationResponse$1, AnalyzeLocationExistingEntity as AnalyzeLocationExistingEntity$1, AnalyzeLocationGenerateEntity as AnalyzeLocationGenerateEntity$1, AnalyzeLocationEntityField as AnalyzeLocationEntityField$1, LocationSpec as LocationSpec$1, CatalogEntityDocument } from '@backstage/plugin-catalog-common';
...
import { CatalogProcessor as CatalogProcessor$1, CatalogProcessorEmit as CatalogProcessorEmit$1, CatalogProcessorParser as CatalogProcessorParser$1, CatalogProcessorCache as CatalogProcessorCache$1, CatalogProcessorResult as CatalogProcessorResult$1, EntityProvider as EntityProvider$1, locationSpecToMetadataName as locationSpecToMetadataName$1, locationSpecToLocationEntity as locationSpecToLocationEntity$1, EntityRelationSpec as EntityRelationSpec$1, DeferredEntity as DeferredEntity$1, CatalogProcessorLocationResult as CatalogProcessorLocationResult$1, CatalogProcessorEntityResult as CatalogProcessorEntityResult$1, CatalogProcessorRelationResult as CatalogProcessorRelationResult$1, CatalogProcessorErrorResult as CatalogProcessorErrorResult$1, CatalogProcessorRefreshKeysResult as CatalogProcessorRefreshKeysResult$1, EntityProviderConnection as EntityProviderConnection$1, EntityProviderMutation as EntityProviderMutation$1 } from '@backstage/plugin-catalog-node';
import { JsonValue } from '@backstage/types';
import { GetEntitiesRequest, CatalogApi } from '@backstage/catalog-client';
import { DocumentCollatorFactory } from '@backstage/plugin-search-common';
import { Permission, PermissionRuleParams, PermissionEvaluator, PermissionAuthorizer } from '@backstage/plugin-permission-common';
 ...
 */
declare type AnalyzeLocationRequest = AnalyzeLocationRequest$1;
/**
 * @public
 * @deprecated use the same type from `@backstage/plugin-catalog-common` instead
 */
declare type AnalyzeLocationResponse = AnalyzeLocationResponse$1;
/**
 ...
 * @deprecated use the same type from `@backstage/plugin-catalog-common` instead
 */
declare type AnalyzeLocationExistingEntity = AnalyzeLocationExistingEntity$1;
/**
 ...
 * @deprecated use the same type from `@backstage/plugin-catalog-common` instead
 */
declare type AnalyzeLocationGenerateEntity = AnalyzeLocationGenerateEntity$1;
/**
 *
 ...
 * @deprecated use the same type from `@backstage/plugin-catalog-common` instead
 */
declare type AnalyzeLocationEntityField = AnalyzeLocationEntityField$1;
/** @public */
...
/** @public */
declare type AnalyzeOptions = {
    url: string;
    catalogFilename?: string;
};
/** @public */
declare type ScmLocationAnalyzer = {
 ...
 * @public
 */
declare type ProcessingIntervalFunction = () => number;
/**
 ...
 * @public
 */
declare type CatalogPermissionRuleInput<TParams extends PermissionRuleParams = PermissionRuleParams> = PermissionRule<Entity, EntitiesSearchFilter, 'catalog-entity', TParams>;
/** @public */
 ...
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type DeferredEntity = DeferredEntity$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type EntityRelationSpec = EntityRelationSpec$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessor = CatalogProcessor$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorParser = CatalogProcessorParser$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorCache = CatalogProcessorCache$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorEmit = CatalogProcessorEmit$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorLocationResult = CatalogProcessorLocationResult$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorEntityResult = CatalogProcessorEntityResult$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorRelationResult = CatalogProcessorRelationResult$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorErrorResult = CatalogProcessorErrorResult$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorRefreshKeysResult = CatalogProcessorRefreshKeysResult$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type CatalogProcessorResult = CatalogProcessorResult$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type EntityProvider = EntityProvider$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type EntityProviderConnection = EntityProviderConnection$1;
/**
 * @public
 * @deprecated import from `@backstage/plugin-catalog-node` instead
 */
declare type EntityProviderMutation = EntityProviderMutation$1;
/**
...
export { AnalyzeLocationEntityField, AnalyzeLocationExistingEntity, AnalyzeLocationGenerateEntity, AnalyzeLocationRequest, AnalyzeLocationResponse, AnalyzeOptions, AnnotateLocationEntityProcessor, AnnotateScmSlugEntityProcessor, BuiltinKindsEntityProcessor, CatalogBuilder, CatalogCollatorEntityTransformer, CatalogEnvironment, CatalogPermissionRuleInput, CatalogProcessingEngine, CatalogProcessor, CatalogProcessorCache, CatalogProcessorEmit, CatalogProcessorEntityResult, CatalogProcessorErrorResult, CatalogProcessorLocationResult, CatalogProcessorParser, CatalogProcessorRefreshKeysResult, CatalogProcessorRelationResult, CatalogProcessorResult, CodeOwnersProcessor, DefaultCatalogCollator, DefaultCatalogCollatorFactory, DefaultCatalogCollatorFactoryOptions, DeferredEntity, EntitiesSearchFilter, EntityFilter, EntityProvider, EntityProviderConnection, EntityProviderMutation, EntityRelationSpec, FileReaderProcessor, LocationAnalyzer, LocationEntityProcessor, LocationEntityProcessorOptions, LocationSpec, PlaceholderProcessor, PlaceholderProcessorOptions, PlaceholderResolver, PlaceholderResolverParams, PlaceholderResolverRead, PlaceholderResolverResolveUrl, ProcessingIntervalFunction, ScmLocationAnalyzer, UrlReaderProcessor, createRandomProcessingInterval, defaultCatalogCollatorEntityTransformer, locationSpecToLocationEntity, locationSpecToMetadataName, parseEntityYaml, processingResult };
