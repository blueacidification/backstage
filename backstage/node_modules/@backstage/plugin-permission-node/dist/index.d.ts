 ...
 * @public
 */
declare function createPermissionIntegrationRouter<TResourceType extends string, TResource>(options: CreatePermissionIntegrationRouterResourceOptions<TResourceType, TResource>): express.Router;
/**
 *
 ...
 * @public
 */
declare function createPermissionIntegrationRouter(options: {
    permissions: Array<Permission>;
}): express.Router;
